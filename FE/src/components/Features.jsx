    ...
    return (
        <div className="relative size-full">
            <video
                ...
                loop
                muted
                className="absolute top-0 left-0 w-full size-full object-cover object-center"
            />
...
const Features = () => {
    return (
        <section className="bg-black pb-52">
            <div className="container mx-auto px-3 mx:px-10">
                <div className="px-5 py-32">
                    <p className="font-circular-web text-lg text-blue-50">
                        Into the Metagame Layer
                    </p>
                    <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
                        Immerse yourself in a rich anh ever-expanding universe
                ...
                <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
                    ...
                    <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
                        <BentoCard
                            ...
                            description="A gamified social hun, adding a new dimension of play to social interaction for Web3 communities."
                        />
                    </BentoTilt>
                    {/* Item 4 */}
